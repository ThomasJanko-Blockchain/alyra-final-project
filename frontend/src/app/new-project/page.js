...
import { PlusCircle, Type, FileText, Coins, Calendar, Link, Copyright } from 'lucide-react';
        ...
        <Card className="max-w-2xl mx-auto">
            ...
            <CardContent>
                <form className='flex flex-col gap-y-6'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        <Label htmlFor='tokenURI' className="flex items-center gap-2">
                    ...
                    <Button 
                        type='submit' 
                        className={`w-full ${isPending ? 'bg-blue-400' : 'bg-blue-500 hover:bg-blue-600'} text-white transition-colors duration-200 flex items-center justify-center gap-2`}
